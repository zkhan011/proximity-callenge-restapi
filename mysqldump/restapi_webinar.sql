...
CREATE TABLE `webinar` (
  ...
  `mycourseid` bigint DEFAULT NULL,
  `subjectid` bigint DEFAULT NULL,
  `title` varchar(255) DEFAULT NULL,
  `totalviews` bigint DEFAULT NULL,
  `url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `mycourseid_idx` (`mycourseid`),
  KEY `subjectid_idx` (`subjectid`),
  CONSTRAINT `mycourseid` FOREIGN KEY (`mycourseid`) REFERENCES `course` (`id`),
...
-- Dump completed on 2021-05-24  1:10:22
